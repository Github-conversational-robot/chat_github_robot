...
os.environ["OPENAI_API_KEY"] = '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'
...
@main_bp.route('/talks/<string:repoName>/<int:userID>', methods=['GET', 'POST'])
def talk(repoName, userID):
